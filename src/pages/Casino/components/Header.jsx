...
const categoriesEn = [
  { name: "All", icon: CategoryIcons["Tümü"] },
  { name: "Favorite", icon: CategoryIcons["Favorite"] },
  { name: "New Games", icon: CategoryIcons["YENİ OYUNLAR"] },
  { name: "Exclusive to ONWIN", icon: CategoryIcons["ONWIN'E ÖZEL OYUNLAR"] },
  { name: "EGT Digital Bell Link", icon: CategoryIcons["EGT Digital Bell Link"] },
  { name: "Get Freespins", icon: CategoryIcons["FREESPİN AL"] },
  { name: "Popular", icon: CategoryIcons["POPÜLER"] },
  { name: "New Year Special", icon: CategoryIcons["Yılbaşı Özel"] },
  { name: "Endorphina 1 Million TRY", icon: CategoryIcons["Endorphina 1 Milyon TL"] },
  { name: "MEGAWAYS SLOTS", icon: CategoryIcons["MEGAWAYS SLOTLAR"] },
  { name: "FRUIT-THEMED SLOTS", icon: CategoryIcons["MEYVE TEMALI SLOTLAR"] },
  { name: "BIG BASS SERIES", icon: CategoryIcons["BİG BASS SERİSİ"] },
];
